...
const UserRepository = ({ userId, repositoryId }) => {
  ...
  return (
    <>
      {repository && user && repositoryBranches && repositoryCollaborators && commitsToMainBranch && (
        <Row className="justify-content-md-center">
          <Col md={10}>
            ...
            <Tabs defaultActiveKey="code" id="uncontrolled-tab-example" className="mb-3" onSelect={handleSelect}>
              <Tab eventKey="code" title="Code">
                <RepositoryCode showCommits={showCommits} setShowCommits={setShowCommits} repository={repository} repositoryBranches={repositoryBranches} isLoggedInUserCollaborator={isLoggedInUserCollaborator()} />
              </Tab>
